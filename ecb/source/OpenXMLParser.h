...
/*
This header file includes the header file for AdvXMLParser developed by
Sebastien Andrivet which is covered by a separate licence see file
_AdvXMLParser.h
*/
...
inline void operator<<(Value value, const bool& b)
{
